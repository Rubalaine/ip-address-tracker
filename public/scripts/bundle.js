...
var search = document.getElementById("search"); // import mapboxgl from "mapbox-gl";

mapboxgl.accessToken = "pk.eyJ1Ijoia2VsdmVuLXJ1YmFsYWluZSIsImEiOiJja2d0MnB3aHowNnRlMnpxcmdkMzM1aWhyIn0.gcDLP6xN4goZ2NPmMOPbVw";

var searchIp = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ipAddress = _args.length > 0 && _args[0] !== undefined ? _args[0] : "";
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            return _context.abrupt("return", ipInfo.data);
...
var map = new mapboxgl.Map({
  container: "map",
  style: "mapbox://styles/kelven-rubalaine/ckgt35vt61rxy19p5hdd4m3u0",
  // stylesheet location
  center: [-122.078514, 45.40599],
...
document.body.addEventListener("load", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
    var _yield$searchIp, location;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _yield$searchIp = _context2.sent;
            location = _yield$searchIp.location;
...
if (search) search.addEventListener("click", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(event) {
    var searchText, ip, location, marker;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return searchIp(searchText);

          case 4:
            ip = _context3.sent;
            changeData(ip);
            location = [ip.location.lng, ip.location.lat];
            map.flyTo({
              center: location,
              speed: 2
            });
            marker = new mapboxgl.Marker().setLngLat(location);
            marker.addTo(map);
...
var changeData = function changeData(address) {
  //   map.flyTo({ center: [address.location.lng, address.location.lat] });
  document.getElementById("address").innerText = address.ip;
  document.getElementById("location").innerText = "".concat(address.location.region, ", ").concat(address.location.city, " ").concat(address.location.postalCode);
